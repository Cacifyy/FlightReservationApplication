...
// Lightweight preview of the AgentPanel UI using mock data
public class AgentPanelPreview extends JPanel {
    ...
    public AgentPanelPreview(String username, int customerId) {
